...
預設 API 是 `https://two0260724.onrender.com`。如需變更，複製 `.env.example` 成 `.env`，並修改 `VITE_API_URL` 後重新啟動開發伺服器。
...
5. 在 Environment 設定 `VITE_API_URL=https://two0260724.onrender.com`，然後部署。
